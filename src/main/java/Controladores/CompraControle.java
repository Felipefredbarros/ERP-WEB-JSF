...
public class CompraControle implements Serializable {
    ...
    public void atualizaPreco() {
        itensCompra.setValorUnitario(itensCompra.getProduto().getValorUnitarioCompra());
    }
    ...
    public void atualizarPreco() {
        Produto produtoSelecionado = itensCompra.getProduto();
        if (produtoSelecionado != null) {
            itensCompra.setValorUnitario(produtoSelecionado.getValorUnitarioCompra());
        }
    }
